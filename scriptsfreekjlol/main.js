...
class GameBasics {
  ...
  getSpaceshipImage() {
    const images = [
      "game/ship.png",
      "Milestone2Noob.png",
      "Milestone3Noob.png" // Add more skin paths as needed
    ];
    return images[this.level - 1]; //adjust for zero-based index
  }
...
window.addEventListener("keydown", function(e) {
  ...
  if (keyboardCode == 'Space' || keyboardCode == 'ArrowLeft' || keyboardCode == 'ArrowRight') {
